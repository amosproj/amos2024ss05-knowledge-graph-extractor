...
import { select, forceSimulation, forceLink, forceManyBody, forceCenter, forceCollide, zoom, drag } from 'd3';
...
const GraphVisualization = () => {
  ...
  useEffect(() => {
    ...
    const simulation = forceSimulation(graphData.nodes)
      .force('link', forceLink(graphData.edges).id(d => d.id).distance(100))
  ...
  return (
    <section className="graph_container">
      ...
      <svg ref={svgRef} style={{ width: '100vw', height: 'calc(100vh - 50px)' }} />
    </section>
  );
};
