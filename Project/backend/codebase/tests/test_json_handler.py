...
def test_valid_json():
    llm_output = '[{"key1": "value1", "key2": "value2"}]'
    expected_output = [{"key1": "value1", "key2": "value2"}]
    assert transform_llm_output_to_dict(llm_output) == expected_output


def test_leading_comments_and_text():
    llm_output = """
...
def test_trailing_text():
    llm_output = '[{"key1": "value1", "key2": "value2"}] Some trailing text.'
    expected_output = [{"key1": "value1", "key2": "value2"}]
    assert transform_llm_output_to_dict(llm_output) == expected_output


def test_double_commas():
    llm_output = '[{"key1": "value1", "key2": "value2",, "key3": "value3"}]'
    expected_output = [{"key1": "value1", "key2": "value2", "key3": "value3"}]
    assert transform_llm_output_to_dict(llm_output) == expected_output


def test_comments_within_json():
    llm_output = """
    [
        {"key1": "value1", "key2": "value2" /* inline comment */, "key3": "value3"},
        // single line comment
...
def test_extra_commas_before_closing_brackets():
    llm_output = '[{"key1": "value1", "key2": "value2",}]'
    expected_output = [{"key1": "value1", "key2": "value2"}]
    assert transform_llm_output_to_dict(llm_output) == expected_output
...
def test_incorrect_json_structure():
    llm_output = "Here is the requested json: [key1: value1, key2: value2]"
    expected_output = {}
    assert transform_llm_output_to_dict(llm_output) == expected_output
...
def test_no_json_found():
    llm_output = "Here is the requested json: no json here."
    expected_output = {}
    assert transform_llm_output_to_dict(llm_output) == expected_output


def test_florian_examples():
    list_of_examples = [
        '[\n   {\n       "node_1": "IOP",\n       "node_2": "Conference",\n       "edge": "part of"\n   '
        '},\n   {\n       "node_1": "Materials",\n       "node_2": "Science",\n       "edge": "related"\n '
        '  },\n   {\n       "node_1": "Engineering",\n       "node_2": "Autonomous",\n       "edge": '
        ...
        '[\n  {\n    "node_1": "Combination of sensors, actuators, machine learning systems and complex '
        'algorithms",\n    "node_2": "Software",\n    "edge": "uses"\n  },\n  {\n    "node_1": '
        ...
        '\n    "edge": "includes"\n  },\n  {\n    "node_1": "Surrounding environment",\n    "node_2": '
        '"Obstacles which the vehicle can encounter",\n    "edge": "includes"\n  },\n  {\n    "node_1": "Car '
        'navigation system",\n    "node_2": "GPS",\n    "edge": "equipped with"\n  },\n  {\n    "node_1": '
        ...
        '\n  {\n    "node_1": "Uber",\n    "node_2": "Autonomous car project",\n    "edge": "partnered '
        'for"\n  }\n]',
        '[\n  {\n    "node_1": "ICCRDA 2020",\n    "node_2": "IOP Conf. Series: Materials Science and '
        'Engineering 1022 (2021) 012028",\n    "edge": "cite"\n  },\n  {\n    "node_1": "ICCRDA 2020",'
        ...
        '"including"\n  },\n  {\n    "node_1": "LIDAR system",\n    "node_2": "vehicles",\n    "edge": '
        '"equipped with"\n  },\n  {\n    "node_1": "LIDAR system",\n    "node_2": "millions of laser '
        'pulses",\n    "edge": "using"\n  },\n  {\n    "node_1": "LIDAR system",\n    "node_2": "360 '
        'degrees",\n    "edge": "measuring"\n  },\n  {\n    "node_1": "high-resolution vision system",'
        '\n    "node_2": "cameras",\n    "edge": "using"\n  },\n  {\n    "node_1": "high-resolution vision '
        'system",\n    "node_2": "world",\n    "edge": "seeing"\n  },\n  {\n    "node_1": "radar '
        'system",\n    "node_2": "objects",\n    "edge": "tracking"\n  },\n  {\n    "node_1": "radar '
        'system",\n    "node_2": "wavelength",\n    "edge": "using"\n  },\n  {\n    "node_1": "Waymo '
        'vehicles",\n    "node_2": "sensors",\n    "edge": "using"\n  },\n  {\n    "node_1": "Waymo '
        ...
        '\n  {\n    "node_1": "sensor systems",\n    "node_2": "Waymo",\n    "edge": "provided_by"\n  },'
        '\n  {\n    "node_1": "image",\n    "node_2": "Figure 2",\n    "edge": "is"\n  }\n]',
        '[\n    {\n        "node_1": "ICCRDA 2020",\n        "node_2": "IOP Conf. Series: Materials Science '
        'and Engineering 1022 (2021)",\n        "edge": "Publication"\n    },\n    {\n        "node_1": "IOP '
        'Conf. Series: Materials Science and Engineering 1022 (2021)",\n        "node_2": '
        ...
        '"Vehicle-to-everything (V2X) suite",\n    "node_2": "Smarter environments",\n    "edge": '
        '"component"\n  },\n  {\n    "node_1": "Volkswagen",\n    "node_2": "Vehicle-to-everything (V2X) '
        'suite",\n    "edge": "uses"\n  }\n]',
        '[\n  {\n    "node_1": "Volkswagen",\n    "node_2": "vehicles",\n    "edge": "owns"\n  },'
        ...
        '"involves"\n  }\n]\n',
        '[\n  {\n    "node_1": "Germany",\n    "node_2": "Autonomous vehicles",\n    "edge": "is related '
        'to"\n  },\n  {\n    "node_1": "German Ethics Commission",\n    "node_2": "Autonomous and Connected '
        ...
        'concept"\n    },\n    {\n        "node_1": "Zeadally S",\n        "node_2": "2018 Autonomous Cars: '
        'Research Results, Issues, and Future Challenges",\n        "edge": "research work"\n    },\n    {\n     '
        '   "node_1": "Zeadally S",\n        "node_2": "IEEE Communications Surveys & Tutorials",'
        '\n        "edge": "author"\n    },\n    {\n        "node_1": "National Highway Traffic Safety '
        'Administration NHTSA",\n        "node_2": "Automated Vehicles for Safety",\n        "edge": '
        '"resource"\n    },\n    {\n        "node_1": "Automated Vehicles for Safety",\n        "node_2": '
        '"safety",\n        "edge": "topic"\n    },\n    {\n        "node_1": "National Highway Traffic '
        'Safety Administration NHTSA",\n        "node_2": "technology",\n        "edge": "related field"\n   '
        ' },\n    {\n        "node_1": "Guerrero-Ibanez J A",\n        "node_2": "2015 Integration challenges '
        "of intelligent transportation systems with connected vehicle, cloud computing, and Internet of Things "
        'technologies",\n        "edge": "research work"\n    },\n    {\n        "node_1": '
        '"Contreras-Castillo J",\n        "node_2": "2017 A seven-layered model architecture for Internet of '
        'Vehicles",\n        "edge": "research work"\n    },\n    {\n        "node_1": "Contreras-Castillo '
        ...
        '\n    "edge": "is relation to"\n  },\n  {\n    "node_1": "IOP Conf. Series: Materials Science and '
    ...
    for i, llm_output in enumerate(list_of_examples):
        assert transform_llm_output_to_dict(llm_output) != {}
